...
const mockBuyer = {
  ...
  // Background
  background:
    "Former tech executive with 15+ years experience building and scaling technology companies. Successfully scaled 3 companies from startup to exit, with a combined exit value of over $150M. Currently managing a $25M investment fund focused on profitable SaaS businesses.",
  ...
  specificRequirements:
    "Looking for profitable SaaS businesses with recurring revenue models. Strong preference for companies with proven product-market fit and growth potential. Must have clean financials and scalable operations.",
  ...
  reviews: [
    {
      ...
      rating: 5,
      comment:
        "Sarah was professional, transparent, and made the entire process smooth. Highly recommend working with her.",
      date: "2 months ago",
    },
    {
      seller: "Lisa Wang",
      ...
      rating: 5,
      comment:
        "Excellent communication and fair deal terms. Sarah brought valuable strategic insights to help grow the business.",
      date: "6 months ago",
    },
  ],
...
export default function BuyerProfile({ params }: { params: { id: string } }) {
  ...
  const handlePass = () => {
    // Get current passed businesses from localStorage
    const passedBusinesses = JSON.parse(localStorage.getItem("passedBusinesses") || "[]")

    // Add this business to passed list
    if (!passedBusinesses.includes(params.id)) {
      passedBusinesses.push(params.id)
  ...
  const handleConnect = () => {
    ...
    // Create match object with business and buyer info
    const matchData = {
      id: params.id,
    ...
    if (!matches.find((match: any) => match.id === params.id)) {
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {mockBuyer.businessTypes.map((type) => (
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-serif font-bold text-lg mb-1">
                  Ready to connect with {mockBuyer.name.split(" ")[0]}?
                </h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => copyToClipboard(`https://${mockBuyer.linkedin}`, "linkedin")}
              >
